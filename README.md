...
You can then execute your native executable with: `./target/vdi-with-quarkus-1.0.0-SNAPSHOT-runner`
...
- Camel Qute ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/qute.html)): Transform messages using Quarkus Qute templating engine
